...
const STRINGS: Dict = {
  ...
  discipline: { fr: 'PROGRAMME', en: 'PROGRAM' },
  ...
  sportInfo: { fr: 'INFORMATIONS SPORTIVES', en: 'SPORT INFO' },
  position: { fr: 'POSITION', en: 'POSITION' },
  secondaryPositions: { fr: 'POSITIONS SECONDAIRES', en: 'SECONDARY POSITIONS' },
  experience: { fr: 'EXPÉRIENCE', en: 'EXPERIENCE' },
  seasonsN: { fr: '{n} saison(s)', en: '{n} season(s)' },
  team: { fr: 'ÉQUIPE', en: 'TEAM' },
  gender: { fr: 'SEXE', en: 'SEX' },
  corpulence: { fr: 'CORPULENCE', en: 'BUILD' },
  school: { fr: 'ÉCOLE', en: 'SCHOOL' },
  studyField: { fr: "DOMAINE D'ÉTUDES", en: 'FIELD OF STUDY' },
  biography: { fr: 'BIOGRAPHIE', en: 'BIOGRAPHY' },
  honors: { fr: 'DISTINCTIONS', en: 'HONORS' },
  links: { fr: 'LIENS', en: 'LINKS' },
  highlightVideo: { fr: 'Vidéo highlight', en: 'Highlight video' },
